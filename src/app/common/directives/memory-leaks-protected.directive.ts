...
@Directive()
export abstract class MemoryLeaksProtectedDirective implements OnDestroy {
  // Taken from https://stackoverflow.com/a/42490431

  // The ReplaySubject will help to keep the directive in an destroyed state even if you try
